    ...
    return (
        <div className="max-w-sm rounded overflow-hidden shadow-lg mx-auto">
            ...
            <div className="px-6 py-4">
                ...
                <button type="button" className="my-5 py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none rounded-full border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 bg-gray-200">Book Now</button>
            </div>
